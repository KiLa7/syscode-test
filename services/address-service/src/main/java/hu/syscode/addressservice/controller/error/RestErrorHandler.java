package hu.syscode.addressservice.controller.error;
...
public class RestErrorHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<Object> handleNotFoundRuntimeException(AddressNotFoundException ex, WebRequest request) {
